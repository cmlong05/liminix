...
# (ethernet only) and ax6600-wifi-ram.nix (ethernet + the 2.4GHz ath11k
# radio; ax6600-wifi-ram-5g.nix adds the QCN9074), which add their services
# (and, from the deployment values,
